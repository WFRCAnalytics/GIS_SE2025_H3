...
export default function App() {
  ...
  const handleHexHover = useCallback((props: Record<string, unknown>) => {
    ...
    setHoveredHex({
      ...
      attain_mf_share:           num(props.attain_mf_share),           attain_mf_share_raw:       num(props.attain_mf_share_raw),
      attain_renter_afford:      num(props.attain_renter_afford),      attain_renter_afford_raw:  num(props.attain_renter_afford_raw),
      attainability_index:       num(props.attainability_index),       attainability_index_raw:   num(props.attainability_index_raw),
